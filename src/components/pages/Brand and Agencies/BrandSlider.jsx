  ...
  return (
    <div style={{ width: '100%', position: 'relative', marginBottom: '7rem' }}>
      <div className="slide__container ">
        ...
        >
          <SwiperSlide>
            <div style={styles.slide} data-aos='slide-up' data-aos-delay='100'>
          ...
          <SwiperSlide>
            <div style={styles.slide} data-aos='slide-up' data-aos-delay='200'>
              <img src={slide2} alt="Icon 2" style={styles.icon} />
              <div style={styles.text}><h3>Proprietary <br /> technoloy</h3>
          ...
          <SwiperSlide>
            <div style={styles.slide} data-aos='slide-up' data-aos-delay='300'>
              <img src={slide3} alt="Icon 3" style={styles.icon} />
              <div style={styles.text}><h3>Future-proof <br /> solution</h3>
                <p>Zeropark ensures that our partners can benefit from sustainable growth opportunities with cookieless engagements that brands and agencies can rely on when designing long-term omnichannel marketing strategies.</p></div>
            </div>
          </SwiperSlide>
          <SwiperSlide>
            <div style={styles.slide} data-aos='slide-up' data-aos-delay='400'>
          ...
          <SwiperSlide>
            <div style={styles.slide} data-aos='slide-up' data-aos-delay='500'>
              <img src={slide5} alt="Icon 4" style={styles.icon} />
              <div style={styles.text}><h3>Brand safety and <br /> trancperency</h3>
          ...
          <SwiperSlide>
            <div style={styles.slide} data-aos='slide-up' data-aos-delay='600'>
              <img src={slide6} alt="Icon 4" style={styles.icon} />
