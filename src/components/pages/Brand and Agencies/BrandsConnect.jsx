        ...
        <div className='brandconnect'>
            <div className="brandconnect__container max-width">
                ...
                <div className='brandconnect__box'>
                    <div className='text' data-aos='fade-up' data-aos-delay='200'><p>The current state of online commerce requires brands to answer every customer interaction, no matter how fleeting.</p><p data-aos='fade-up' data-aos-delay='300'>That’s why creating shoppable moments that help streamline the consumer journey from inspiration to purchase is what seamless customer experience is all about.</p></div>
                    <div className="icons">
